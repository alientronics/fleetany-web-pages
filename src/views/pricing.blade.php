@extends('fleetany-web-pages::web-pages-default')

@section('contentpage')

	<h2>{!!Lang::get('fleetany-web-pages::webpages.Pricing')!!}</h2>
	...
	<p>Fusce mollis velit nulla, a dictum sem blandit nec. Ut congue at justo sit amet fringilla. Sed ornare magna ac ligula auctor suscipit. Donec faucibus sodales ipsum, vel imperdiet tortor accumsan in. In vitae iaculis elit. Vestibulum nec purus erat. Integer a euismod turpis. Fusce dapibus augue ut erat faucibus, eu aliquet velit venenatis. Praesent eget pharetra tellus. Morbi vulputate dolor id faucibus consequat. Sed et ligula nunc.</p>
